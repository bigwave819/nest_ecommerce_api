...
import { Order, OrderItems, OrderStatus, Product, User } from '@prisma/client';
...
export class OrdersService {
  ...
  async create(
    ...
    const { items, shippinsAddress } = createOrderDto;
  ...
  private wrap(
    order: Order & {
      orderItems: (OrderItems & { product: Product })[];
      user: User;
    },
  ...
  private map(
    ...
    return {
      ...
      shippingAddress: order.shippinsAddress ?? '',
